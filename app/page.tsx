...
import { TravelListings } from "@/components/travel-listings"
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
              ...
              <div className="flex flex-col items-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <p className="mx-auto max-w-[700px] text-white md:text-xl">
                    Discover eco-friendly destinations and reduce your carbon footprint while exploring the world.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-12 bg-green-50">
          <div className="container px-4 md:px-6">
            <h2 className="text-2xl font-bold mb-8 text-center">Featured Eco-Friendly Destinations</h2>
